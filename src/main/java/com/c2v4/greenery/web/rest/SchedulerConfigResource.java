...
public class SchedulerConfigResource {
    ...
    public ResponseEntity<SchedulerConfig> createSchedulerConfig(@RequestBody SchedulerConfig schedulerConfig) throws URISyntaxException {
    ...
    public ResponseEntity<SchedulerConfig> updateSchedulerConfig(@RequestBody SchedulerConfig schedulerConfig) throws URISyntaxException {
