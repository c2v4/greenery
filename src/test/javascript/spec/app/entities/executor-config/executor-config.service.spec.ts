...
describe('Service Tests', () => {
  describe('ExecutorConfig Service', () => {
    let injector: TestBed;
    let service: ExecutorConfigService;
    let httpMock: HttpTestingController;
    let elemDefault: IExecutorConfig;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ExecutorConfig', async () => {
        ...
        service
          .create(new ExecutorConfig(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should delete a ExecutorConfig', async () => {
