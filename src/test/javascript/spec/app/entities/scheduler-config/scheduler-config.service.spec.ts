...
describe('Service Tests', () => {
  describe('SchedulerConfig Service', () => {
    let injector: TestBed;
    let service: SchedulerConfigService;
    let httpMock: HttpTestingController;
    let elemDefault: ISchedulerConfig;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a SchedulerConfig', async () => {
        ...
        service
          .create(new SchedulerConfig(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should delete a SchedulerConfig', async () => {
